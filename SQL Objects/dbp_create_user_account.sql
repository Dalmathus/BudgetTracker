...
IF EXISTS (SELECT 1 FROM sys.procedures WHERE name = 'dbp_create_user_account') DROP PROCEDURE dbo.dbp_create_user_account
GO

SET QUOTED_IDENTIFIER OFF
GO

CREATE PROCEDURE dbo.dbp_create_user_account
                 @pv_first_name NVARCHAR(100),
